...
<div class="container">
    <h1>Surface Furniture</h1>
    <?php include "add_a_product1.php" ?>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="product-card">
                    ...
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] !== 'admin'): ?>
                        ...
                        <?php endif; ?>
                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                        <a href="pages/backend/edit_product1.php?product_id=<?php echo $product_id; ?>">Edit</a>
                        
                        <!-- Delete button - links to a delete handler with product_id as a query parameter -->
                        <a href="pages/backend/delete_product1.php?product_id=<?php echo $product_id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
                        <?php endif; ?>
                    </div>
                </div>
