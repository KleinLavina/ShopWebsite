    ...
    <div style="background-color: #1E4C6D; padding: 20px; border-radius: 8px; width: 450px;">
        <form method="POST" action="" style="display: flex; flex-direction: column;">
            ...
            <div style="margin-bottom: 10px;">
                ...
                <input type="text" id="course" name="course" style="width: 100%; padding: 10px; border-radius: 4px; border: 1px solid #555; background-color: #68AEDD; color: white;" required placeholder="Enter Address">
            </div>
