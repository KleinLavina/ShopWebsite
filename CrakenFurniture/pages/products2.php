...
<div class="container">
    <h1>Lounge</h1>
    <?php include "add_a_product2.php" ?>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="product-card">
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="pages/backend/edit_product2.php?product_id=<?php echo $product_id; ?>">Edit</a>
                        
                        <!-- Delete button - links to a delete handler with product_id as a query parameter -->
                        <a href="pages/backend/delete_product2.php?product_id=<?php echo $product_id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
                        <?php endif; ?>
                    </div>
                </div>
