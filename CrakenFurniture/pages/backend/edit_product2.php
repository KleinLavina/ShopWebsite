...
if (isset($_GET['product_id'])) {
    ...
    $sql = "SELECT * FROM products2 WHERE product_id = ?";
...
<form action="update_product2.php" method="post" enctype="multipart/form-data">
    ...
    <textarea  placeholder="Enter the description" name="description" id="description" required><?php echo htmlspecialchars($product['description']); ?></textarea>
