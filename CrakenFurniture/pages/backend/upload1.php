...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
        ...
        $sql = "INSERT INTO products1 (product_name, price, description, image_name, image_data) 
                VALUES (?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param("sdsss", $product_name, $price, $description, $image_name, $image_data);  // "s" stands for string, "d" for double (price), and "b" for blob (image data)
