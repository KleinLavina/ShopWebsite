...
<body>
    ...
    <button style="float:right; margin-right:5px; "class="show-form-btn" onclick="toggleForm()"> + Add an Item</button>

    <div class="form-container" id="form-container">
        <div class="container">
            <button class="exit-btn" onclick="toggleForm()">Exit</button>
            <h3>Add an Item</h3>
