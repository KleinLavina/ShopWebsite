...
<style>
    *{
        ...
        /* Edit, Delete, and Add to Cart buttons */
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="product-card">
                        ...
                        <button style="padding: 20px; background-color: #fff44f; color: black; border: none; font-size: 16px; cursor: pointer; border-radius: 5px; transition: background-color 0.3s ease;">
                        Add to Cart
                    </button>

<style>
    button:hover {
        opacity: 0.8; /* A darker shade of yellow for the hover effect */
    }
</style>
                        ...
                        <div class="action-buttons">
                            ...
                            <!-- Add to Cart button - links to a cart handler with product_id as a query parameter -->
                        </div>
                    </div>
                    <?php
                }
